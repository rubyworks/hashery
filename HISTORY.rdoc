...
The Hash#read core extension has been renamed to Hash#retrieve to avoid
any possible confusion with IO objects. This release also fixes a couple
of issues with 1.8 compatability and makes a few other enhancements.
...
* Fix OpenHash issues with Ruby 1.8.x compatability.
