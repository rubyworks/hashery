...
# sake.
# 
# Intersting side note, SparseArray is also the first piece of code it's 
# humble author used TDD to create.
#
# SparseArray, being of a more expirmental nature, is not loaded along with
# the other Hasery libraries when using `require 'hashery'.
#
